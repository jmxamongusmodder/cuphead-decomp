			...
			Program "vp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    vs_TEXCOORD4.y = abs(u_xlat0.x) * u_xlat15 + u_xlat16;
					    ...
					    vs_TEXCOORD4.x = u_xlat5 * 0.5 + u_xlat0.x;
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat25 = u_xlat25 + (-vs_TEXCOORD4.x);
					    u_xlat25 = u_xlat25 * vs_TEXCOORD4.y + 0.5;
					    ...
					    u_xlat12.xy = vec2(_OutlineUVSpeedX, _OutlineUVSpeedY) * _Time.yy + vs_TEXCOORD0.zw;
					    ...
					    u_xlat11 = u_xlat3.y * vs_TEXCOORD4.y + 1.0;
					    ...
					    u_xlat12.x = vs_TEXCOORD4.x + _BevelOffset;
					    u_xlat2.x = u_xlat4.w;
					    u_xlat2.y = u_xlat5.w;
					    u_xlat2.z = u_xlat3.w;
					    ...
					    u_xlat26 = dot(vs_TEXCOORD5.xyz, u_xlat4.xyz);
					    u_xlat26 = u_xlat26 + u_xlat26;
					    u_xlat4.xyz = u_xlat4.xyz * (-vec3(u_xlat26)) + vs_TEXCOORD5.xyz;
					    ...
					    u_xlat16 = inversesqrt(u_xlat16);
					    u_xlat2.xyz = vec3(u_xlat16) * u_xlat5.xyz;
					    ...
					    u_xlat9.x = u_xlat25 * 128.0;
					    u_xlat1.x = log2(u_xlat1.x);
					    u_xlat1.x = u_xlat1.x * u_xlat9.x;
					    u_xlat1.x = exp2(u_xlat1.x);
					    u_xlat9.xyz = u_xlat8.xyz * u_xlat3.xyz;
					    u_xlat8.xyz = u_xlat8.xyz * _SpecColor.xyz;
					    u_xlat8.xyz = u_xlat1.xxx * u_xlat8.xyz;
					    u_xlat0.xyz = u_xlat9.xyz * u_xlat0.xxx + u_xlat8.xyz;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat31 = u_xlat31 + (-vs_TEXCOORD4.x);
					    u_xlat31 = u_xlat31 * vs_TEXCOORD4.y + 0.5;
					    u_xlat3.x = _OutlineWidth * _ScaleRatioA;
					    u_xlat3.y = _OutlineSoftness * _ScaleRatioA;
					    u_xlat3.xz = u_xlat3.xy * vs_TEXCOORD4.yy;
					    u_xlat6 = vs_COLOR0 * _FaceColor;
					    ...
					    u_xlat13 = u_xlat3.y * vs_TEXCOORD4.y + 1.0;
					    ...
					    u_xlatb4 = u_xlat4.x>=0.5;
					    u_xlat14.x = vs_TEXCOORD4.x + _BevelOffset;
					    u_xlat2.x = u_xlat4.w;
					    u_xlat2.y = u_xlat5.w;
					    u_xlat2.z = u_xlat3.w;
					    ...
					    u_xlat4.xyz = unity_ObjectToWorld[0].xyz * u_xlat2.xxx + u_xlat4.xyz;
					    u_xlat4.xyz = unity_ObjectToWorld[2].xyz * u_xlat2.zzz + u_xlat4.xyz;
					    u_xlat32 = dot(vs_TEXCOORD5.xyz, u_xlat4.xyz);
					    u_xlat32 = u_xlat32 + u_xlat32;
					    u_xlat4.xyz = u_xlat4.xyz * (-vec3(u_xlat32)) + vs_TEXCOORD5.xyz;
					    u_xlat4 = texture(_Cube, u_xlat4.xyz);
					    u_xlat5.xyz = (-_ReflectFaceColor.xyz) + _ReflectOutlineColor.xyz;
					    ...
					    u_xlat10.xyz = u_xlat6.xyz + vs_TEXCOORD6.xyz;
			...
			Program "vp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat0.xyz = u_xlat1.yyy * _EnvMatrix[1].xyz;
					    u_xlat0.xyz = _EnvMatrix[0].xyz * u_xlat1.xxx + u_xlat0.xyz;
					    vs_TEXCOORD6.xyz = _EnvMatrix[2].xyz * u_xlat1.zzz + u_xlat0.xyz;
					    return;
					}"
				}
				SubProgram "d3d11 " {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat6 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat25 = (-u_xlat6.w) + 0.5;
					    u_xlat25 = u_xlat25 + (-vs_TEXCOORD5.x);
					    u_xlat25 = u_xlat25 * vs_TEXCOORD5.y + 0.5;
					    u_xlat3.x = _OutlineWidth * _ScaleRatioA;
					    u_xlat3.y = _OutlineSoftness * _ScaleRatioA;
					    ...
					    u_xlat4.x = (-u_xlat3.x) * 0.5 + u_xlat25;
					    u_xlat19 = u_xlat3.z * 0.5 + u_xlat4.x;
					    u_xlat11 = u_xlat3.y * vs_TEXCOORD5.y + 1.0;
					    u_xlat11 = u_xlat19 / u_xlat11;
					    u_xlat11 = clamp(u_xlat11, 0.0, 1.0);
					    u_xlat11 = (-u_xlat11) + 1.0;
					    u_xlat25 = u_xlat3.x * 0.5 + u_xlat25;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat9.x = u_xlat9.x * vs_TEXCOORD5.y;
					    u_xlat16 = _OutlineSoftness * _ScaleRatioA;
					    u_xlat3.x = u_xlat16 * vs_TEXCOORD5.y;
					    ...
					    u_xlat4.xy = vec2(_OutlineUVSpeedX, _OutlineUVSpeedY) * _Time.yy + vs_TEXCOORD0.zw;
					    ...
					    u_xlat16 = u_xlat16 * vs_TEXCOORD5.y + 1.0;
					    ...
					    if(u_xlatb2){
					        ...
					        u_xlat2.xyz = (bool(u_xlatb2)) ? u_xlat9.xyz : vs_TEXCOORD4.xyz;
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    if(u_xlatb16){
					        ...
					        u_xlat4.xyz = (bool(u_xlatb16)) ? u_xlat4.xyz : vs_TEXCOORD4.xyz;
