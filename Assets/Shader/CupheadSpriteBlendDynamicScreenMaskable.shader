		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0.x = (-_Amount) + 1.0;
					    u_xlat3.xyz = (-vs_COLOR0.xyz) + vec3(1.0, 1.0, 1.0);
					    u_xlat1 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat2.xyz = (-u_xlat1.xyz) + vec3(1.0, 1.0, 1.0);
					    u_xlat3.xyz = (-u_xlat3.xyz) * u_xlat2.xyz + vec3(1.0, 1.0, 1.0);
					    u_xlat3.xyz = u_xlat3.xyz * vec3(_Amount);
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat9 = _EnableExternalAlpha * u_xlat9 + u_xlat1.w;
