			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat0 = u_xlat0 * vs_COLOR0;
					    u_xlat3 = min(u_xlat0.w, 0.400000006);
					    SV_Target0.xyz = vec3(u_xlat3) * u_xlat0.xyz;
					    SV_Target0.w = u_xlat3;
					    return;
					}"
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1.w = _EnableExternalAlpha * u_xlat0.x + u_xlat1.w;
					    u_xlat0 = u_xlat1 * vs_COLOR0;
					    u_xlat6 = min(u_xlat0.w, 0.400000006);
					    SV_Target0.xyz = vec3(u_xlat6) * u_xlat0.xyz;
					    SV_Target0.w = u_xlat6;
					    return;
					}"
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat0 = u_xlat0 * vs_COLOR0;
					    u_xlat3 = min(u_xlat0.w, 0.300000012);
					    SV_Target0.xyz = vec3(u_xlat3) * u_xlat0.xyz;
					    SV_Target0.w = u_xlat3;
					    return;
					}"
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1.w = _EnableExternalAlpha * u_xlat0.x + u_xlat1.w;
					    u_xlat0 = u_xlat1 * vs_COLOR0;
					    u_xlat6 = min(u_xlat0.w, 0.300000012);
					    SV_Target0.xyz = vec3(u_xlat6) * u_xlat0.xyz;
					    SV_Target0.w = u_xlat6;
					    return;
					}"
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat0 = u_xlat0 * vs_COLOR0;
					    u_xlat3 = min(u_xlat0.w, 0.200000003);
					    SV_Target0.xyz = vec3(u_xlat3) * u_xlat0.xyz;
					    SV_Target0.w = u_xlat3;
					    return;
					}"
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1.w = _EnableExternalAlpha * u_xlat0.x + u_xlat1.w;
					    u_xlat0 = u_xlat1 * vs_COLOR0;
					    u_xlat6 = min(u_xlat0.w, 0.200000003);
					    SV_Target0.xyz = vec3(u_xlat6) * u_xlat0.xyz;
					    SV_Target0.w = u_xlat6;
					    return;
					}"
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    u_xlat0 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat0 = u_xlat0 * vs_COLOR0;
					    u_xlat3 = min(u_xlat0.w, 0.100000001);
					    SV_Target0.xyz = vec3(u_xlat3) * u_xlat0.xyz;
					    SV_Target0.w = u_xlat3;
					    return;
					}"
				...
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1.w = _EnableExternalAlpha * u_xlat0.x + u_xlat1.w;
					    u_xlat0 = u_xlat1 * vs_COLOR0;
					    u_xlat6 = min(u_xlat0.w, 0.100000001);
					    SV_Target0.xyz = vec3(u_xlat6) * u_xlat0.xyz;
					    SV_Target0.w = u_xlat6;
					    return;
					}"
